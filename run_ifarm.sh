...
#TODO: Fix -> temporarily using inb because outb is slow
kFDo=$kFDi #/volatile/clas12/kenjo/bclary/phi_skim/outb/epKpKm_RGA_OUT.hipo #Brandons outb events
...
wait 
#Should make new hipo based on previous for this next cut so I don't double cut mm2 and vz!
...
run-groovy gen_hist.groovy $kFDi $rdir/mass_vz_cop_ikk_cuts_inb.root $pdir/mass_vz_cop_cuts_inb/fits.json ikk ecut pcut kpcut kmcut vzcut cpcut ckpcut ckmcut ikkcut &
run-groovy gen_hist.groovy $kFDo $rdir/mass_vz_cop_ikk_cuts_outb.root $pdir/mass_vz_cop_cuts_outb/fits.json ikk ecut pcut kpcut kmcut vzcut cpcut ckpcut ckmcut ikkcut &
