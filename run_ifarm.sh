...
kFD=/volatile/clas12/kenjo/bclary/phi_skim/inb/skim8_*.hipo #Brandons inb events
#kFD=/volatile/clas12/kenjo/bclary/phi_skim/outb/epKpKm_RGA_OUT.hipo #Brandons outb events
...
run-groovy gen_hist.groovy $kFD $rdir/no_cuts.root $pdir/hists/fits.json all 
python2.7 kaon/my_analysis.py $rdir/no_cuts.root $pdir/hists/

#My analysis
run-groovy gen_hist.groovy $kFD $rdir/mass_cuts.root $pdir/hists/fits.json all ecut pcut kpcut kmcut &
run-groovy gen_hist.groovy $kFD $rdir/vz_cut.root    $pdir/hists/fits.json all vzcut &
run-groovy gen_hist.groovy $kFD $rdir/cp_cut.root    $pdir/hists/fits.json all cpcut &
run-groovy gen_hist.groovy $kFD $rdir/ckp_cut.root   $pdir/hists/fits.json all ckpcut &
run-groovy gen_hist.groovy $kFD $rdir/ckm_cut.root   $pdir/hists/fits.json all ckmcut &
run-groovy gen_hist.groovy $kFD $rdir/cop_cuts.root  $pdir/hists/fits.json all cpcut ckpcut ckmcut &
run-groovy gen_hist.groovy $kFD $rdir/ikk_cuts.root  $pdir/hists/fits.json all ikk &
run-groovy gen_hist.groovy $kFD $rdir/all_cuts.root  $pdir/hists/fits.json all ecut pcut kpcut kmcut vzcut cpcut ckpcut ckmcut ikk &
...
run-groovy gen_hist.groovy $kFD $rdir/mass_vz_cop_ikk_cuts.root $pdir/mass_vz_cop_ikk_cuts/fits.json ikk ecut pcut kpcut kmcut vzcut cpcut ckpcut ckmcut ikkcut
